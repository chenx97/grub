...
#if !defined (GRUB_MACHINE_EMU) && ((defined (__mips__) && !defined (_ABI64)) || defined (__i386__) || defined (__x86_64__))
...
#if ((defined(__mips__) && !defined(_ABI64)) || defined (__i386__) || defined (__x86_64__)) && !defined(GRUB_MACHINE_EMU) && !defined(GRUB_MACHINE_ARC)
...
grub_cmd_serial (grub_extcmd_context_t ctxt, int argc, char **args)
{
  ...
  if (err)
    return err;
#if !defined (GRUB_MACHINE_EMU) && !defined(GRUB_MACHINE_ARC) && ((defined(__mips__) && !defined(_ABI64)) || defined (__i386__) || defined (__x86_64__))
